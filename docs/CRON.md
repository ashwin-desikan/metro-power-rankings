...
| CFB predictions (sim + AP-25 slate + grading) | `mac-mini-jobs/runners/cfb.sh` (**live since 2026-08-20**) | Sun 23:40 + Fri 11:40 UTC, ~Aug-Jan | mac mini | `[vercel skip]` + ISR (`predictions-daily` tag); slate lags the AP poll, grades lag finals |
