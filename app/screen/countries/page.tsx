...
export const metadata: Metadata = {
  ...
  openGraph: { images: [{ url: ogImage(TITLE, `/screen/countries`), width: 1200, height: 630 }], title: `${TITLE} | ${SITE_NAME}`, description: DESC, url: `${BASE_URL}/screen/countries`, type: "website" },
};
