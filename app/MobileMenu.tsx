  ...
  const geography: SubGroup[] = [
    {
      ...
      items: [
        ...
        { href: '/ground-floor', label: '🏗️ The Ground Floor' },
        { href: '/countries', label: '🏳️ Countries' },
        { href: '/states', label: '🗺️ States & Provinces' },
        { href: '/skyscrapers', label: '🏙️ Supertall Skyscrapers' },
        { href: '/expandable-map', label: '🧭 Expandable Map' },
        { href: '/compare', label: '⚖️ Compare metros' },
        { href: '/matchups/london-vs-new-york', label: '🥊 Matchups' },
        { href: '/neighborhoods', label: '🏘️ Neighborhoods' },
      ],
    },
    {
      label: '👑 Power & people',
      items: [
        ...
        { href: '/leaders', label: '🎖️ World Leaders' },
        { href: '/power-atlas', label: '🏛️ The Power Atlas' },
        { href: '/us-political-leadership', label: '🏛️ US Political Leadership' },
        { href: '/uk-political-leadership', label: '🏛️ UK Political Leadership' },
        ...
        { href: '/mayors', label: '🏙️ Mayors of the World' },
      ],
    },
    {
      label: '🤝 Geopolitics',
      items: [
        ...
        { href: '/conflicts', label: '⚔️ Interstate Wars' },
      ],
    },
    {
      ...
      items: [
        ...
        { href: '/order/recognition-gap', label: '⚖️ The Recognition Gap' },
      ],
    },
    {
      label: '🕰️ Across time',
  ...
  const culture: SubGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/screen/countries', label: '🌍 Rankings by Country' },
        { href: '/screen/people', label: '🎭 People' },
        { href: '/screen/films', label: '🎞️ Films' },
        { href: '/screen/years', label: '📅 Year by Year' },
        { href: '/screen/number-ones', label: '1️⃣ US Number Ones' },
        { href: '/screen/oscars', label: '🏆 Oscar Winners' },
        { href: '/screen/academy', label: '🎓 The Academy' },
        { href: '/screen/canon', label: '📽️ 500 Greatest Films' },
      ],
    },
  ];
