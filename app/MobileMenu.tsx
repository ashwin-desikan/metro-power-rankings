...
const ITEMS: Item[] = [
  ...
  { href: '/teams/football', label: 'Club Football', hint: 'Big 5 European top flights plus the full English pyramid; canonical club pages and league hubs', group: 'Sports' },
