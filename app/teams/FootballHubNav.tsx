        ...
        {DESTS.map((d) => {
          ...
          return (
            <Link
              ...
              className={`inline-flex items-center min-h-[44px] text-xs px-3 py-1.5 rounded-full border transition-colors ${on ? "font-semibold" : "hover:text-[var(--text)] hover:border-[var(--text-dim)]"}`}
              style={{
