  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <header className="flex gap-5 items-start mb-8">
        <div className="rounded-2xl grid place-items-center font-extrabold flex-shrink-0 text-xl text-white" style={{ background: t.color, width: 72, height: 72, boxShadow: `inset 0 0 0 3px ${t.color2}` }} aria-hidden>{cfbMonogram(t.name)}</div>
