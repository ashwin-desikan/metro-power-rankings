...
const GAMES: Game[] = [
  ...
  { title: "Stadium Stacker", emoji: "\u{1F3DF}\u{FE0F}", file: "stadium-stacker.html", ages: "7–10", blurb: "Build match-day crowds from hundreds, tens and ones, then take the \u{1F680} Expert level: place value in the MILLIONS on real metro populations, order five cities, count through zero.", group: "think" },
  { title: "Big Match Adder", emoji: "\u2795", file: "big-match-adder.html", ages: "7–10", blurb: "Add and subtract crowds like a club accountant: estimate first, type the exact answer, prove it with the inverse check. \u{1F680} Expert brings five-digit crowds and missing-number puzzles.", group: "think" },
  { title: "Times-Table Striker", emoji: "\u2716\u{FE0F}", file: "times-table-striker.html", ages: "7–10", blurb: "Times tables through three-pointers, cricket fours and rowing eights. \u{1F680} Expert adds remainders, missing numbers and 2-digit×2-digit, and \u26A1 Blitz gives you 60 seconds to set a record.", group: "think" },
  ...
  { title: "Chart Champions", emoji: "\u{1F4CA}", file: "chart-champions.html", ages: "7–10", blurb: "Real league titles and skyscraper skylines as bar charts, pictograms and tables. 🚀 Expert reads real city scales: hundreds of skyscrapers, millions of people on the axis.", group: "think" },
...
export default function PlayHub() {
  ...
  return (
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 20px 40px" }}>
      ...
      <p style={{ color: "#5b7b97", fontSize: ".95rem", margin: "4px 0 0" }}>
        A full maths workout: place value, times tables, fractions, shapes, time and charts, built from real teams, stadiums and skylines. Games carry ⭐ Year 3 and 🌟 Year 4 levels, and the core four now go up to 🚀 Expert.
      </p>
      <Grid games={think} />
