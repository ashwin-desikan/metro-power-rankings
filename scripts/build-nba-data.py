...
def main():
    ...
    (OUT_DIR / "all-nba-selections.json").write_text(json.dumps(all_nba_by_team, indent=2, ensure_ascii=False))

    (OUT_DIR / "all-star-counts.json").write_text(json.dumps(all_star_counts, indent=2, ensure_ascii=False))
