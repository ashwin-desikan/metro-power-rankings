...
export const RELEASES: Release[] = [
  {
    date: "2026-09-04",
    headline: "Four books on every game, and a map of political order",
    items: [
      ...
      "Handball no longer outscores tennis, and swimming is no longer weighted as a minor Olympic sport. Filter the board by what a sport is too: the football family tree, the ones a panel decides, the ones won sitting down.",
    ],
  },
  {
    date: "2026-09-03",
    ...
    items: [
      "Every prediction hub, the Ledger and Picks now share the site's hub design: one header and tab row, phone-sized lists instead of sideways tables, a sources card, and each team's week-over-week move, range and band.",
