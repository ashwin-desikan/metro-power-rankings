...
export const RELEASES: Release[] = [
  {
    date: "2026-05-20",
    headline: "Side feed, map fixes: pin above polygon, tighter zoom",
    items: [
      "New sticky side feed sits next to the rankings at lg+: Discover entry points, latest essays from the journal, recently shipped releases, plus Random metro and Methodology CTAs. Wraps below the table on tablet and phone.",
      ...
      "Map: filter changes (Top 25 / Top 100, continent, region, search) now zoom into the visible set more aggressively (padding tightened from 15% span to 6%); animated fit with a 0.5s ease so toggles read as motion, not a jump cut.",
      "Release notes data extracted to lib/releases.ts so the home sidebar and the /updates page share a single source of truth; brevity validator still gates writes on the /updates renderer.",
    ],
  },
  {
    date: "2026-05-20",
