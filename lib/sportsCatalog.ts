...
export const SPORTS_CATALOG: CatalogEntry[] = [
  ...
  { href: "/teams/cbb-w", label: "Women's College Basketball", boardLabel: "College (W)", sport: "Basketball", family: "Basketball", scope: "college", hint: "Every Division I women's program: all-time NCAA tournament records, national titles, Final Fours, and champions since 1982." },
