# HANDOFF archive - 2026-07-19 to 2026-07-31

Second July archive, cut from HANDOFF.md on 2026-08-07 when that file reached 363 KB.
HANDOFF-ARCHIVE-2026-07.md holds 2026-07-02 to 2026-07-12. Entries for 2026-07-13 to
2026-07-18 exist in neither file; they were never written or were lost in the first
archive move. Read-only record. Do not append here - append to HANDOFF.md.

Line endings: CRLF, matching HANDOFF.md. Nothing enforces this (.gitattributes has no
*.md rule), so appends made from the mini land as bare LF and get renormalised.
